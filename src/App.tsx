...
import { calculatePaintNeeds, type DimensionState } from './engine/calculatePaint';
import { type PaintColor, PAINT_DATABASE } from './engine/paintDatabase';
import { findClosestPaintColor } from './engine/colorEngine';
...
export default function App() {
  ...
  // Cálculo da Calculadora de Tintas (delega para engine pura)
  const calculationResults = calculatePaintNeeds(calcDimensions);
